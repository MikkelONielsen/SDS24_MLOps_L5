...
def fetch_model_details(model_id):
    response = requests.get(f"https://render-fastapi-ku5n.onrender.com/model/?model_id={model_id}") #use this link as template : https://render-fastapi-ku5n.onrender.com/docs#/
    if response.status_code == 200: #error 200 means it works
...
# Model selection (this way is simple, in reality we make it advanced by giving the values in from the db)
model_options = {
    "Model 1": 101, 
    "Model 2": 102,
}
